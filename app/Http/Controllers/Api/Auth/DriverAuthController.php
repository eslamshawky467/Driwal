...
class DriverAuthController extends Controller
{
    ...
    public function register(Request $request){
        $validator = Validator::make($request->all(), [
            ...
            'password' => 'required|string|min:8',
            'phonenumber'=>'required|unique:drivers,phonenumber',
        ...
        $user = Driver::create(array_merge(
            $request->except(['driver_image','car_image','front_license_image','back_license_image','front_id_image','back_id_image','front_certificate_vehicle_image','back_certificate_vehicle_image']),
    ...
    public function code(Request $request)
    {
        ...
        $validator=Validator::make($request->all(),[
            'code' => 'required|string|exists:rese_password_drivers,code',
