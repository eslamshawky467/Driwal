...
} elseif ($_instance->childHasBeenRendered('yWmFlCB')) {
    $componentId = $_instance->getRenderedChildComponentId('yWmFlCB');
    $componentTag = $_instance->getRenderedChildComponentTagName('yWmFlCB');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('yWmFlCB');
} else {
    $response = \Livewire\Livewire::mount('package-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('yWmFlCB', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Salm-mostafa_driwal_transaction_task\resources\views/admin/packages/search.blade.php ENDPATH**/ ?>