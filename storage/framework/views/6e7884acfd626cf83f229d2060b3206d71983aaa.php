<?php $__env->startSection('content'); ?>
    ...
    <div>
        <h2><?php echo e(trans('request.requests')); ?></h2>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile shadow">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <a href="<?php echo e(route('package_company.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo e(trans('trip.createpackagecompany')); ?></a>
                        </div>
                    <div class="row">
                        <div class="container">
                        </div>
                                ...
                                <table class="table datatable" id="admins-table" style="width: 100%;">
                                    ...
                                    <?php $__currentLoopData = $requests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr id="sid<?php echo e($request->id); ?>">
                                            ...
                                            <td><a href="<?php echo e(route('requests.showLocation',$request->id)); ?>" class="btn btn-primary btn-sm"><?php echo e(trans('trip.show_location')); ?></a></td>
