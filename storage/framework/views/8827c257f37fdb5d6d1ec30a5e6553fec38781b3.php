...
} elseif ($_instance->childHasBeenRendered('WxQ5XRi')) {
    $componentId = $_instance->getRenderedChildComponentId('WxQ5XRi');
    $componentTag = $_instance->getRenderedChildComponentTagName('WxQ5XRi');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WxQ5XRi');
} else {
    $response = \Livewire\Livewire::mount('driver');
    $html = $response->html();
    $_instance->logRenderedChild('WxQ5XRi', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
