...
} elseif ($_instance->childHasBeenRendered('BbM04HO')) {
    $componentId = $_instance->getRenderedChildComponentId('BbM04HO');
    $componentTag = $_instance->getRenderedChildComponentTagName('BbM04HO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('BbM04HO');
} else {
    $response = \Livewire\Livewire::mount('companies');
    $html = $response->html();
    $_instance->logRenderedChild('BbM04HO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Draiwal\resources\views/admin/companies/index.blade.php ENDPATH**/ ?>