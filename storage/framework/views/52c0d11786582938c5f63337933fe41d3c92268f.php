...
} elseif ($_instance->childHasBeenRendered('qHZAtLc')) {
    $componentId = $_instance->getRenderedChildComponentId('qHZAtLc');
    $componentTag = $_instance->getRenderedChildComponentTagName('qHZAtLc');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('qHZAtLc');
} else {
    $response = \Livewire\Livewire::mount('search-clint');
    $html = $response->html();
    $_instance->logRenderedChild('qHZAtLc', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
