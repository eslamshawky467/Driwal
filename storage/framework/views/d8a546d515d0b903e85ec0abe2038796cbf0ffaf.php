            ...
            <div class="tile shadow">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="number_plate" class="form-control" value="<?php echo e(old('number_plate', $driver->number_plate)); ?>">
                    </div>

                    
                    <div class="form-group">
                        <label><?php echo e(trans('admin.governorate')); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="governorate" class="form-control" value="<?php echo e(old('governorate', $driver->governorate)); ?>">
                    </div>

                    
                    <div class="form-group">
                        <label><?php echo e(trans('admin.neighborhood')); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="neighborhood" class="form-control" value="<?php echo e(old('neighborhood', $driver->neighborhood)); ?>">
                    </div>

                    
                    <div class="form-group">
                        <label><?php echo e(trans('admin.street')); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="street" class="form-control" value="<?php echo e(old('street', $driver->street)); ?>">
                    </div>

                    
                    <div class="form-group">
                        <label><?php echo e(trans('admin.building_number')); ?> <span class="text-danger">*</span></label>
                        <input type="number" name="building_number" class="form-control" value="<?php echo e(old('building_number', $driver->building_number)); ?>">
                    </div>
