...
} elseif ($_instance->childHasBeenRendered('0Rba1zD')) {
    $componentId = $_instance->getRenderedChildComponentId('0Rba1zD');
    $componentTag = $_instance->getRenderedChildComponentTagName('0Rba1zD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0Rba1zD');
} else {
    $response = \Livewire\Livewire::mount('companies');
    $html = $response->html();
    $_instance->logRenderedChild('0Rba1zD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/companies/index.blade.php ENDPATH**/ ?>