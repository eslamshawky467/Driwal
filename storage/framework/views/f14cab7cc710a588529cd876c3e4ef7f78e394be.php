...
} elseif ($_instance->childHasBeenRendered('VXO2CSZ')) {
    $componentId = $_instance->getRenderedChildComponentId('VXO2CSZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('VXO2CSZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('VXO2CSZ');
} else {
    $response = \Livewire\Livewire::mount('orders');
    $html = $response->html();
    $_instance->logRenderedChild('VXO2CSZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Draiwal\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>