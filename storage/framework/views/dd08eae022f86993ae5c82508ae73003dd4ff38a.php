...
} elseif ($_instance->childHasBeenRendered('WWyrYVX')) {
    $componentId = $_instance->getRenderedChildComponentId('WWyrYVX');
    $componentTag = $_instance->getRenderedChildComponentTagName('WWyrYVX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WWyrYVX');
} else {
    $response = \Livewire\Livewire::mount('search-clint');
    $html = $response->html();
    $_instance->logRenderedChild('WWyrYVX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
