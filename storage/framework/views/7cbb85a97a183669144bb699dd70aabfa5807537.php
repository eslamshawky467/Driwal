...
} elseif ($_instance->childHasBeenRendered('GY6Cjdu')) {
    $componentId = $_instance->getRenderedChildComponentId('GY6Cjdu');
    $componentTag = $_instance->getRenderedChildComponentTagName('GY6Cjdu');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('GY6Cjdu');
} else {
    $response = \Livewire\Livewire::mount('package-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('GY6Cjdu', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/packages/search.blade.php ENDPATH**/ ?>