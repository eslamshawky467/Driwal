...
} elseif ($_instance->childHasBeenRendered('AQY40gZ')) {
    $componentId = $_instance->getRenderedChildComponentId('AQY40gZ');
    $componentTag = $_instance->getRenderedChildComponentTagName('AQY40gZ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('AQY40gZ');
} else {
    $response = \Livewire\Livewire::mount('driver');
    $html = $response->html();
    $_instance->logRenderedChild('AQY40gZ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/driver/index.blade.php ENDPATH**/ ?>