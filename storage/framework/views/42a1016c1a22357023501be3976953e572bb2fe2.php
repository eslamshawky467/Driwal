...
} elseif ($_instance->childHasBeenRendered('EkRDIKh')) {
    $componentId = $_instance->getRenderedChildComponentId('EkRDIKh');
    $componentTag = $_instance->getRenderedChildComponentTagName('EkRDIKh');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('EkRDIKh');
} else {
    $response = \Livewire\Livewire::mount('driver');
    $html = $response->html();
    $_instance->logRenderedChild('EkRDIKh', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Salm-mostafa_draiwal_dashboard_edit_task\resources\views/admin/driver/index.blade.php ENDPATH**/ ?>