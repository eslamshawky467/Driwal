                ...
                <form action="<?php echo e(route('driver.update', 'test')); ?>" method="post"enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select  class="form-select" aria-label="Default select example" name="status"
                            ...
                            <option type="hidden" value="<?php echo e($driver->status); ?>"><?php echo e($driver->status); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select  class="form-select" aria-label="Default select example" name="nation"
                                 id="exampleFormControlTextarea1" placeholder="." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 1px;font-size: 15px;">
                            <option type="hidden" value="<?php echo e($driver->nationality_id); ?>"><?php echo e($driver->nation->name_ar); ?></option>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/driver/edit.blade.php ENDPATH**/ ?>