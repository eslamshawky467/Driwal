...
} elseif ($_instance->childHasBeenRendered('Ggu4FL5')) {
    $componentId = $_instance->getRenderedChildComponentId('Ggu4FL5');
    $componentTag = $_instance->getRenderedChildComponentTagName('Ggu4FL5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Ggu4FL5');
} else {
    $response = \Livewire\Livewire::mount('search-live-admin');
    $html = $response->html();
    $_instance->logRenderedChild('Ggu4FL5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Driwal-mona_register_driver\resources\views/admin/admins/index.blade.php ENDPATH**/ ?>