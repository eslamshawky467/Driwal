...
} elseif ($_instance->childHasBeenRendered('8aMzBxQ')) {
    $componentId = $_instance->getRenderedChildComponentId('8aMzBxQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('8aMzBxQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('8aMzBxQ');
} else {
    $response = \Livewire\Livewire::mount('companies');
    $html = $response->html();
    $_instance->logRenderedChild('8aMzBxQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
