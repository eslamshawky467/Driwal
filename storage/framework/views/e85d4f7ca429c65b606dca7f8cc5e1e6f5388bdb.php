...
} elseif ($_instance->childHasBeenRendered('OuJiD1s')) {
    $componentId = $_instance->getRenderedChildComponentId('OuJiD1s');
    $componentTag = $_instance->getRenderedChildComponentTagName('OuJiD1s');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('OuJiD1s');
} else {
    $response = \Livewire\Livewire::mount('search-live-admin');
    $html = $response->html();
    $_instance->logRenderedChild('OuJiD1s', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
