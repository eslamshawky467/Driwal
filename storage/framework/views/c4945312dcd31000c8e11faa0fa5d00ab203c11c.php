...
<aside class="app-sidebar" style="background-color: #161616">
    ...
    <ul class="app-menu" >
        <li class="treeview  " style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-first-order"></i><span class="app-menu__label"><?php echo e(trans('admin.requests')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu"style="background-color: #161616">
                <li>
                    <a class="treeview-item" href="<?php echo e(route('requestion.create')); ?>"><i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label"><?php echo e(trans('admin.createrequest')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('requestion.index')); ?>"><i class="app-menu__icon fa fa-first-order"></i> <span class="app-menu__label"><?php echo e(trans('admin.requests')); ?></span></a>
                </li>
            </ul>
        </li>
    </ul>
