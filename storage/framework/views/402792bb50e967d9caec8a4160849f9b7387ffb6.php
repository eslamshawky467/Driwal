            ...
            <div class="tile shadow">
                <form action="<?php echo e(route('clints.update', 'test')); ?>" method="post"enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_number" class="form-control" value="<?php echo e(old('phone_number', $users->phonenumber)); ?>" required>
                    </div>
                    <div class="form-group">
                        <label><?php echo e(trans('admin.identity_card')); ?> <span class="text-danger">*</span></label>
                        <input type="text" name="identity_card" class="form-control" value="<?php echo e(old('identity_card', $users->id_number)); ?>" required>
                    </div>
                    ...
                    <?php if(app()->getLocale() == 'en'): ?>
                        <div class="form-group">
                            ...
                            <select  class="form-select" aria-label="Default select example" name="nationality_id"
                                ...
                                <option  value="<?php echo e($users->nationality_id); ?>"><?php echo e($users->nationality->name_en); ?></option>
                    ...
                    <div class="form-group">
                        ...
                        <select  class="form-select" aria-label="Default select example" name="status"
                                 id="exampleFormControlTextarea1" placeholder="." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 1px;font-size: 15px;">
                            <option type="hidden" value="<?php echo e($users->status); ?>"><?php echo e(trans('admin.'.$users->status)); ?></option>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\draiwal\resources\views/admin/users/edit.blade.php ENDPATH**/ ?>