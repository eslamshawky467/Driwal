...
} elseif ($_instance->childHasBeenRendered('3sjhenF')) {
    $componentId = $_instance->getRenderedChildComponentId('3sjhenF');
    $componentTag = $_instance->getRenderedChildComponentTagName('3sjhenF');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('3sjhenF');
} else {
    $response = \Livewire\Livewire::mount('companies');
    $html = $response->html();
    $_instance->logRenderedChild('3sjhenF', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Driwal-mona_register_driver\resources\views/admin/companies/index.blade.php ENDPATH**/ ?>