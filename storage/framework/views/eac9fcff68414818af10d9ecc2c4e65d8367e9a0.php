    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="<?php echo e(route('firebasedriver.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" step="1" name="start_cost" autofocus class="form-control" value="<?php echo e(old('start_cost')); ?>">
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\draiwal\resources\views/admin/driverfirebase/create.blade.php ENDPATH**/ ?>