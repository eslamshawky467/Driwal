            ...
            <div class="tile shadow">
                ...
                <div class="col-md-12">
                    <div class="container">
                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('order-active')->html();
} elseif ($_instance->childHasBeenRendered('0zUnzWl')) {
    $componentId = $_instance->getRenderedChildComponentId('0zUnzWl');
    $componentTag = $_instance->getRenderedChildComponentTagName('0zUnzWl');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('0zUnzWl');
} else {
    $response = \Livewire\Livewire::mount('order-active');
    $html = $response->html();
    $_instance->logRenderedChild('0zUnzWl', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Draiwal\resources\views/admin/orders/active.blade.php ENDPATH**/ ?>