            ...
            <div class="tile shadow">
                <form action="<?php echo e(route('Companies.update', 'test')); ?>" method="post"enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="phone_number" class="form-control" value="<?php echo e(old('phone_number', $campany->phonenumber)); ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select  class="form-select" aria-label="Default select example" name="status"
                            ...
                            <option type="hidden" value="<?php echo e($campany->status); ?>"><?php echo e($campany->status); ?></option>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/companies/edit.blade.php ENDPATH**/ ?>