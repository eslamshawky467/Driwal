...
} elseif ($_instance->childHasBeenRendered('zVvVCP4')) {
    $componentId = $_instance->getRenderedChildComponentId('zVvVCP4');
    $componentTag = $_instance->getRenderedChildComponentTagName('zVvVCP4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('zVvVCP4');
} else {
    $response = \Livewire\Livewire::mount('driver');
    $html = $response->html();
    $_instance->logRenderedChild('zVvVCP4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Driwal-mona_register_driver\resources\views/admin/driver/index.blade.php ENDPATH**/ ?>