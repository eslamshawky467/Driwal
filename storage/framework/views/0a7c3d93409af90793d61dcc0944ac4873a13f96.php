...
} elseif ($_instance->childHasBeenRendered('SN7b7cD')) {
    $componentId = $_instance->getRenderedChildComponentId('SN7b7cD');
    $componentTag = $_instance->getRenderedChildComponentTagName('SN7b7cD');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SN7b7cD');
} else {
    $response = \Livewire\Livewire::mount('search-live-admin');
    $html = $response->html();
    $_instance->logRenderedChild('SN7b7cD', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\draiwal\resources\views/admin/admins/index.blade.php ENDPATH**/ ?>