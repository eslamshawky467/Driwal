...
} elseif ($_instance->childHasBeenRendered('q6foGR8')) {
    $componentId = $_instance->getRenderedChildComponentId('q6foGR8');
    $componentTag = $_instance->getRenderedChildComponentTagName('q6foGR8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('q6foGR8');
} else {
    $response = \Livewire\Livewire::mount('search-live-admin');
    $html = $response->html();
    $_instance->logRenderedChild('q6foGR8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
