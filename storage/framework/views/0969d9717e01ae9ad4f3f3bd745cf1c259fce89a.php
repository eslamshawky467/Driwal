            ...
            <div class="tile shadow">
                ...
                <div class="col-md-12">
                    <div class="container">
                        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('order-approved')->html();
} elseif ($_instance->childHasBeenRendered('hkiRQSY')) {
    $componentId = $_instance->getRenderedChildComponentId('hkiRQSY');
    $componentTag = $_instance->getRenderedChildComponentTagName('hkiRQSY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('hkiRQSY');
} else {
    $response = \Livewire\Livewire::mount('order-approved');
    $html = $response->html();
    $_instance->logRenderedChild('hkiRQSY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Draiwal\resources\views/admin/orders/approved.blade.php ENDPATH**/ ?>