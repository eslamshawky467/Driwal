...
<aside class="app-sidebar" style="background-color: #161616">
   ...
   <ul class="app-menu" >
            ...
            <ul class="app-menu" >
                <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label"><?php echo e(trans('admin.Companies')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu"style="background-color: #161616">
                        ...
                        <li><a class="treeview-item" href="<?php echo e(route('package_company.create')); ?>">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                            <?php echo e(trans('trip.createpackagecompany')); ?></a>
                        </li>
    ...
    <ul class="app-menu" >
        <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label"><?php echo e(trans('trip.trips')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu"style="background-color: #161616">
                <li><a class="treeview-item" href="<?php echo e(route('trips.finished')); ?>">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                        <?php echo e(trans('trip.finished')); ?></a>
                </li>
                <li><a class="treeview-item" href="<?php echo e(route('trips.canceled')); ?>">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                        <?php echo e(trans('trip.canceled')); ?></a>
                </li>
                <li><a class="treeview-item" href="<?php echo e(route('trips.unfinished')); ?>">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                        <?php echo e(trans('trip.unfinished')); ?></a>
                </li>
                <li><a class="treeview-item" href="<?php echo e(route('trips.approved')); ?>">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                        <?php echo e(trans('trip.approved')); ?></a>
                </li>
