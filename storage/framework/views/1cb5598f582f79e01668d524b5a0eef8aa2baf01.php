...
<aside class="app-sidebar" style="background-color: #161616">
    ...
    <ul class="app-menu" >
        ...
        <li class="treeview" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label"><?php echo e(trans('admin.freeOrder')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu"style="background-color: #161616">
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.active')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.active')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.approved')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.approved')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.finished')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.finished')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.inActive')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.inActive')); ?></span></a>
                </li>
    ...
    <ul class="app-menu" >
        ...
        <li class="treeview" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-users"></i><span class="app-menu__label"><?php echo e(trans('admin.payedOrder')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu"style="background-color: #161616">
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.active.payed')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.active')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.approved.payed')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.approved')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.finished.payed')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.finished')); ?></span></a>
                </li>
                <li>
                    <a class="treeview-item" href="<?php echo e(route('order.inActive.payed')); ?>"><i class="app-menu__icon fa fa-users"></i> <span class="app-menu__label"><?php echo e(trans('order.inActive')); ?></span></a>
                </li>
   ...
   <ul class="app-menu" >
    ...
    <ul class="app-menu" >
        <li class="treeview  " style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-usd"></i><span class="app-menu__label"><?php echo e(trans('admin.cost')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu"style="background-color: #161616">
                <li>
                    <a class="treeview-item" href="<?php echo e(route('costs.index')); ?>"><i class="app-menu__icon fa fa-pencil-square"></i> <span class="app-menu__label"><?php echo e(trans('admin.editcost')); ?></span></a>
                </li>
            </ul>
        </li>
    </ul>
    ...
    <li>
        ...
        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
            ...
            <ul class="app-menu" >
                <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label"><?php echo e(trans('car.car_types')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu"style="background-color: #161616">
                      <li><a class="treeview-item" href="<?php echo e(route('car_type.create')); ?>">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                            <?php echo e(trans('car.create_car_types')); ?></a>
                        </li>
                       <li><a class="treeview-item" href="<?php echo e(route('car_type.index')); ?>">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                            <?php echo e(trans('car.index_car_types')); ?></a>
                        </li>
            ...
            <ul class="app-menu" >
                <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label"><?php echo e(trans('car.car_models')); ?></span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu"style="background-color: #161616">
                      <li><a class="treeview-item" href="<?php echo e(route('car_model.create')); ?>">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                            <?php echo e(trans('car.create_car_models')); ?></a>
                        </li>
                       <li><a class="treeview-item" href="<?php echo e(route('car_model.index')); ?>">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                            <?php echo e(trans('car.index_car_models')); ?></a>
                        </li>
...
<?php /**PATH C:\laragon\www\Draiwal\resources\views/layouts/admin/_aside.blade.php ENDPATH**/ ?>