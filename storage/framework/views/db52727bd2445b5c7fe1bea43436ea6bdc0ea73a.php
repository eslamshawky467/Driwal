            ...
            <div class="tile shadow">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class='col-md-12'>
                            <div class="form-group">
                                <label><?php echo e(trans('admin.discount_trips')); ?> <span class="text-danger">*</span></label>
                                <input type="number" step="1" name="discount_trips" autofocus class="form-control" value="<?php echo e(old('discount_trips')); ?>" required>
                            </div>
                        </div-col-md-12>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Draiwal\resources\views/admin/zones/create.blade.php ENDPATH**/ ?>