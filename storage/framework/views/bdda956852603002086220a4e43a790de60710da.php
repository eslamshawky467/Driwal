...
} elseif ($_instance->childHasBeenRendered('ETnPB5P')) {
    $componentId = $_instance->getRenderedChildComponentId('ETnPB5P');
    $componentTag = $_instance->getRenderedChildComponentTagName('ETnPB5P');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ETnPB5P');
} else {
    $response = \Livewire\Livewire::mount('package-search', []);
    $html = $response->html();
    $_instance->logRenderedChild('ETnPB5P', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Driwal-mona_register_driver\resources\views/admin/packages/search.blade.php ENDPATH**/ ?>