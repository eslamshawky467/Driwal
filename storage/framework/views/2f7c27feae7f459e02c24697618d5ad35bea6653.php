            ...
            <div class="tile shadow">
                ...
                <form method="post" action="<?php echo e(route('clints.store')); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="phone_number" class="form-control" value="<?php echo e(old('phone_number')); ?>" required>
                    </div>

                    <div class="form-group">
                        <label><?php echo e(trans('admin.identity_card')); ?> <span class="text-danger">*</span></label>
                        <input type="number" name="identity_card" class="form-control" value="<?php echo e(old('identity_card')); ?>" required>
                    </div>
...
<?php echo $__env->make('layouts.admin.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\daiwal\resources\views/admin/users/create.blade.php ENDPATH**/ ?>