            ...
            <div class="tile shadow">
                <div class="row mb-2">
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{route('transaction.bulk_delete')}}" style="display: inline-block;">
                            @csrf
                            @method('delete')
            ...
            <div class="table-responsive">
                <table class="table datatable" id="admins-table" style="width: 100%;">
                    ...
                    @foreach($transactions as $t)
                        <tr id="sid{{ $t->id}}">
                            <td>
                                <input type="checkbox" name="ids[{{ $t->id }}]" class="checkbox" value="{{ $t->id }}"/>
                            </td>
                            <td>
                                {{$t->amount}}</td>
                            <td>
                            ...
                            <td><a href="{{route('deletetransaction',$t->id)}}" class="btn btn-danger btn-sm">{{ trans('admin.delete') }}</a></td>
                        </tr>
                    @endforeach
                    </tbody>
