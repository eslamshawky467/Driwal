            ...
            <div class="tile shadow">
                <form action="{{ route('driver.update', 'test') }}" method="post"enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="phone_number" class="form-control" value="{{ old('phone_number', $driver->phonenumber) }}">
                    </div>

                    <div class="form-group">
                        <label>{{trans('admin.start_cost')}} <span class="text-danger">*</span></label>
                        <input type="number" step="1" name="start_cost" autofocus class="form-control" value="{{ old('start_cost',$driver->start_cost) }}">
                    </div>
