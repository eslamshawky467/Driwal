            ...
            <div class="tile shadow">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="number_plate" class="form-control" value="{{ old('number_plate', $driver->number_plate) }}">
                    </div>

                    {{--governorate --}}
                    <div class="form-group">
                        <label>{{trans('admin.governorate')}} <span class="text-danger">*</span></label>
                        <input type="text" name="governorate" class="form-control" value="{{ old('governorate', $driver->governorate) }}">
                    </div>

                    {{--neighborhood --}}
                    <div class="form-group">
                        <label>{{trans('admin.neighborhood')}} <span class="text-danger">*</span></label>
                        <input type="text" name="neighborhood" class="form-control" value="{{ old('neighborhood', $driver->neighborhood) }}">
                    </div>

                    {{--street --}}
                    <div class="form-group">
                        <label>{{trans('admin.street')}} <span class="text-danger">*</span></label>
                        <input type="text" name="street" class="form-control" value="{{ old('street', $driver->street) }}">
                    </div>

                    {{--building number --}}
                    <div class="form-group">
                        <label>{{trans('admin.building_number')}} <span class="text-danger">*</span></label>
                        <input type="number" name="building_number" class="form-control" value="{{ old('building_number', $driver->building_number) }}">
                    </div>
