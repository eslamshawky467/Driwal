        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{route('driver.store')}} " enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="id_number" autofocus class="form-control" value="{{ old('id_number') }}">
                    </div>
                      {{--license expiration--}}
                      <div class="form-group">
                        <label>{{trans('admin.license_expiration')}} <span class="text-danger">*</span></label>
                        <input type="date" name="license_expiration" autofocus class="form-control" value="{{ old('license_expiration') }}">
                    </div>
                      {{--license number--}}
                      <div class="form-group">
                        <label>{{trans('admin.license_number')}} <span class="text-danger">*</span></label>
                        <input type="number" name="license_number" autofocus class="form-control" value="{{ old('license_number') }}">
                    </div>

                     {{--number plate --}}
                     <div class="form-group">
                        <label>{{trans('admin.number_plate')}} <span class="text-danger">*</span></label>
                        <input type="text" name="number_plate" autofocus class="form-control" value="{{ old('number_plate') }}">
                    </div>

                     {{-- transport year--}}
                     <div class="form-group">
                        <label>{{trans('admin.transport_year')}} <span class="text-danger">*</span></label>
                        <input type="date" name="transport_year" autofocus class="form-control" value="{{ old('transport_year') }}">
                    </div>

                     {{--governorate --}}
                     <div class="form-group">
                        <label>{{trans('admin.governorate')}} <span class="text-danger">*</span></label>
                        <input type="text" name="governorate" autofocus class="form-control" value="{{ old('governorate') }}">
                    </div>

                     {{--neighborhood --}}
                     <div class="form-group">
                        <label>{{trans('admin.neighborhood')}} <span class="text-danger">*</span></label>
                        <input type="text" name="neighborhood" autofocus class="form-control" value="{{ old('neighborhood') }}">
                    </div>

                     {{--street --}}
                     <div class="form-group">
                        <label>{{trans('admin.street')}} <span class="text-danger">*</span></label>
                        <input type="text" name="street" autofocus class="form-control" value="{{ old('street') }}">
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="building_number" autofocus class="form-control" value="{{ old('building_number') }}">
              </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" step="1" name="start_cost" autofocus class="form-control" value="{{ old('start_cost') }}">
                    </div>
