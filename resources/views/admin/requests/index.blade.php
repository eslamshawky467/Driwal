    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="tile shadow">
                <div class="row mb-2">
                    <div class="col-md-12">
                        <a href="{{ route('package_company.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> {{trans('trip.createpackagecompany')}}</a>
                        </div>
                    <div class="row">
                        <div class="container">
                        </div>
                                ...
                                <table class="table datatable" id="admins-table" style="width: 100%;">
                                    ...
                                    @foreach($requests as $request)
                                        <tr id="sid{{ $request->id}}">
                                            ...
                                            <td><a href="{{route('requests.showLocation',$request->id)}}" class="btn btn-primary btn-sm">{{ trans('trip.show_location') }}</a></td>
