            ...
            <div class="tile shadow ">
                ...
                <form method="post" action="{{ route('properties.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        ...
                        <input type="number" name="remain_units" autofocus class="form-control" value="{{ old('remain_units') }}" required>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input id="investement_percentage" type="number" name="investement_percentage" rows="10" cols="30" class="form-control" disabled required>
                   </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="category_2" autofocus class="form-control" value="{{ old('title') }}" required>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="category_3" autofocus class="form-control" value="{{ old('title') }}" required>
                    </div>
