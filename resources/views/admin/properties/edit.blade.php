        ...
        <div class="col-md-12">
            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{ route('properties.updateProperity',$property->id) }}">
                    ...
                    <div class="form-group ">
                        <label>{{trans('admin.remain_units')}} <span class="text-danger">*</span></label>
                        <input type="number" name="remain_units" autofocus class="form-control" value="{{ old('remain_units', $property->remain_units) }}" required>
                    </div>
                    ...
                    <div class="form-group ">
                        <label>{{trans('admin.investement_percentageProperty')}} <span class="text-danger">*</span></label>
                        <input id="investement_percentage" type="number" name="investement_percentage" rows="10" cols="30" class="form-control" value="{{$property->investement_percentage}}"disabled required>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="category_2" autofocus class="form-control" value="{{ old('category_2', $property->category_2) }}" required>
                    </div>
                    ...
                    <div class="form-group ">
                        ...
                        <input type="text" name="category_3" autofocus class="form-control" value="{{ old('category_3', $property->category_3) }}" required>
                    </div>
