            ...
            <div class="tile shadow">
                ...
                <form method="post" action="{{route('car_type.store')}}">
                    ...
                    <div class="form-group">
                        <label>{{trans('admin.type_en')}} <span class="text-danger">*</span></label>
                        <input type="text" name="type_en" autofocus class="form-control" value="{{ old('type_en') }}">
                    </div>

                   {{--type_ar--}}
                   <div class="form-group">
                        <label>{{trans('admin.type_ar')}} <span class="text-danger">*</span></label>
