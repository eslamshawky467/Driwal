...
@section('content')
    ...
    <ul class="breadcrumb mt-2">
        <li class="breadcrumb-item">{{trans('admin.requests')}}</li>
    </ul>
    <div class="row">
        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                <table class="table datatable" id="admins-table" style="width: 100%;">
                                    ...
                                    @foreach($requests->file as $file)
                                        ...
                                        <td>  <a href="{{route('request.file.delete',$file->id)}}" class="btn btn-danger btn-sm">{{trans('admin.delete')}}</a></td>
                                        </tr>
                                    @endforeach
