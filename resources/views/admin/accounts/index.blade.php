                                ...
                                <table class="table datatable" id="admins-table" style="width: 100%;">
                                    ...
                                    @foreach($accounts as $account)
                                        ...
                                        <tr id="sid{{ $account->id}}">
                                            ...
                                            <a href="{{route('deleteaccount',$account->id)}}" class="btn btn-danger btn-sm">{{trans('admin.delete')}}</a>
                                    ...
                                    <tr id="sid{{ $account->id}}">
                                        ...
                                        <a href="{{route('show_details',$account->id)}}" class="btn btn-danger btn-sm">{{trans('admin.show')}}</a></td>
                                    </tr>
@endif
                                    @endforeach
                                    </tbody>
