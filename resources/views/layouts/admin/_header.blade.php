<!-- Navbar-->
<header class="app-header" style="background-color: #BB000E"><a class="app-header__logo" style="font-family: 'Cairo', 'sans-serif';background-color: #BB000E" href="{{ route('dashboard') }}">  {{ trans('admin.Vali') }}</a>
    ...
    <ul class="app-nav">
        ...
        <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-tasks"></i></a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
                <li><a  class="dropdown-item" href="{{ route('admin.profile') }}"><i class="app-menu__icon fa fa-user"></i>{{ trans('admin.Profile') }}</a></li>
                <li>
