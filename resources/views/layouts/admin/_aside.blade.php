...
<aside class="app-sidebar" style="background-color: #161616">
    ...
    <li>
        ...
        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
            ...
            <ul class="app-menu" >
                <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label">{{ trans('admin.car_types') }}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu"style="background-color: #161616">
                      <li><a class="treeview-item" href="{{route('car_type.create')}}">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                            {{ trans('admin.create_car_types') }}</a>
                        </li>
                       <li><a class="treeview-item" href="{{route('car_type.index')}}">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                            {{ trans('admin.index_car_types') }}</a>
                        </li>
            ...
            <ul class="app-menu" >
                <li class="treeview is-expanded" style="background-color: #161616"><a class="app-menu__item" href=" " data-toggle="treeview"><i class="app-menu__icon fa fa-lock"></i><span class="app-menu__label">{{ trans('admin.car_models') }}</span><i class="treeview-indicator fa fa-angle-right"></i></a>
                    <ul class="treeview-menu"style="background-color: #161616">
                      <li><a class="treeview-item" href="{{route('car_model.create')}}">
                        <i class="app-menu__icon fa fa-plus"></i> <span class="app-menu__label">
                            {{ trans('admin.create_car_models') }}</a>
                        </li>
                       <li><a class="treeview-item" href="{{route('car_model.index')}}">
                        <i class="app-menu__icon fa fa-lock"></i> <span class="app-menu__label">
                            {{ trans('admin.index_car_models') }}</a>
                        </li>
