    ...
    [
        ...
        Route::group(
            ...
            function () {
                ...
                Route::get('driver/deleteFile/{id}', [DriverController::class, 'delete'])->name('driver.delete');
...
////////////////////////////// orders  free////////////
     Route::get('order/active', [OrderController::class, 'active'])->name('order.active');
     Route::get('order/approved', [OrderController::class, 'approved'])->name('order.approved');
     Route::get('order/finished', [OrderController::class, 'finished'])->name('order.finished');
     Route::get('order/inActive', [OrderController::class, 'inActive'])->name('order.inActive');
////////////////////////////////orders payed ///////////
Route::get('order/active/payed', [OrderController::class, 'payedActive'])->name('order.active.payed');
Route::get('order/approved/payed', [OrderController::class, 'payedApproved'])->name('order.approved.payed');
Route::get('order/finished/payed', [OrderController::class, 'payedFinished'])->name('order.finished.payed');
Route::get('order/inActive/payed', [OrderController::class, 'payedInActive'])->name('order.inActive.payed');
////////////////////////////////////////////////////
 ...
 Route::post('delete/car_type/{id}',[CarTypeController::class,'delete'])->name('car_type.delete');
  ...
  Route::post('costs/edit',[CostController::class,'edit'])->name('costs.edit');

                });
            });
        });

Route::resource('firebasedriver', \Firebase\DriverFirebaseController::class);
