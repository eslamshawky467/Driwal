...
use App\Http\Controllers\Admin\PackageCompany;
...
Route::group(
 ...
 Route::post('delete/car_type/{id}',[CarTypeController::class,'delete'])->name('car_type.delete');
  ...
  Route::post('costs/edit',[CostController::class,'edit'])->name('costs.edit');
    ...
    Route::resource('package_company', 'PackageCompany');
  Route::post('package_company/create',[PackageCompany::class,'store'])->name('package_company.store');
   
                    ////////////// trips

                    Route::resource('trips', 'TripController');
                    Route::get('finished/trips',[TripController::class,'finished'])->name('trips.finished');
                    Route::get('canceled/trips',[TripController::class,'canceled'])->name('trips.canceled');
                    Route::get('unfinished/trips',[TripController::class,'unfinished'])->name('trips.unfinished');
                    Route::get('approved/trips',[TripController::class,'approved'])->name('trips.approved');
